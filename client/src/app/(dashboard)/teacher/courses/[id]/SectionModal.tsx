...
const SectionModal = () => {
  ...
  useEffect(() => {
    // console.log("Effect Triggered for section:", section);
    if (section) {
      methods.reset({
  ...
  const onSubmit = (data: SectionFormData) => {
    ...
    if (selectedSectionIndex === null) {
      console.log("Before dispatching action:", newSection);
      dispatch(addSection(newSection));
      console.log("After dispatching action"); // You can log this immediately after dispatch
    } else {
      dispatch(
        editSection({
