...
const CourseEditor = () => {
  ...
  useEffect(() => {
    //if the course was there in database we update the courseformdata.
    if (course) {
      methods.reset({
      ...
      dispatch(setSections(course.sections || [])); // updating the section in the state reducer by sending it array os section.
    }
  }, [course, methods]);
