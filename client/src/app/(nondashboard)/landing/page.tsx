  ...
  return (
    ...
    >
        ...
        <div className="landing__hero-images">
          {["/hero1.jpg", "/hero2.jpg", "/hero3.jpg"].map((src, index) => (
            <Image
              ...
              //On screens < 768px, image takes 100% width (100vw) , On screens < 1200px, it takes 50% width else Otherwise, it takes 33% width
              sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" 
              // lets say currentimage = 3, then image three is visible rest all are not.
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
        viewport={{ amount: 0.3, once: true }} //The animation triggers when 30% of the component is visible in the viewport.
