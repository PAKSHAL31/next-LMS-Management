...
const AppSideBar = () => {
  ...
  const pathname = usePathname(); // change layout depending on the pathname. as in video page it will be different and different in other pages.
  const { toggleSidebar } = useSidebar(); //use to toggle the sidebar.
