declare global {
  ...
  /*Omit<T, K> is a built-in TypeScript utility that:
  - Takes a type T.
  - Removes the property (or properties) specified by K from that type.
  - Returns a new type without those properties.
*/
